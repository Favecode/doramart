...
function EventCard({ icon: Icon, title, description, number }) {
  return (
    <div className="group relative bg-night-100 border border-gold/10 p-8 hover:bg-night-200 hover:border-gold/30 transition-all duration-400 cursor-default">
