...
const events = [
  {
    ...
    title: 'Weddings',
    description:
      'Toast to forever with exquisite signature cocktails and champagne service. We craft custom drink menus to match your love story.',
    number: '01',
    src: WeddingImg, // ✅ local JPG
  },
  {
    icon: Crown,
    title: 'Birthdays',
    description:
      'Make your milestone moments shine with personalized cocktail bars, festive mocktails, and beautiful fruit displays.',
    number: '02',
    src: BirthdayImg, // ✅ local JPG
  },
  {
    icon: Briefcase,
    title: 'Corporate Events',
    description:
      'Impress clients and reward teams with sophisticated bar service and curated drink selections that reflect your brand.',
    number: '03',
  ...
  },
  {
    ...
    description:
      'Invite-only exclusivity meets premium hospitality. We bring the luxury lounge experience directly to your space.',
    number: '04',
  ...
  },
  {
    ...
    description:
      'Create buzz and memorable interactions with branded cocktail stations, customized menus, and immersive drink experiences.',
    number: '05',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="relative bg-gradient-to-br from-gold/15 via-gold/8 to-transparent border border-gold/30 p-8 flex flex-col justify-between">
            ...
            <div className="relative">
              ...
              <h3 className="font-serif text-2xl text-gold-champagne mt-3 mb-3">
                We Handle Custom Events Too
              </h3>
              <p className="text-brown-light text-sm leading-relaxed font-light">
                Every gathering is unique. Reach out and let us design a bespoke
                beverage experience tailored to your vision.
              </p>
            </div>

            <a
              href="#booking"
              className="relative mt-8 inline-flex items-center gap-3 text-sm tracking-[0.15em] uppercase text-gold font-medium group"
            >
